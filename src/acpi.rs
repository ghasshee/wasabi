...
trait AcpiTable {
    ...
    fn new(header: &SystemDescriptionTableHeader) -> &Self::Table {
        ...
        // This is safe as far as phys_addr points to a valid MCFG table 
        // and it will be alive forever.
...
// chap. 5 : p 314 
// MCFG : PCI Express "M"emeory-mapped "Con"F"i"G"uration 
