...
#[test_case] 
fn rount_up_to_nearest_pow2_tests() {
    //unimplemented!("cargo tet should fail, right...?")
...
/// Vertical bar '|' represetnts the chunk that has a Header
/// before: |-- prev -------|------ self --------------
/// align : |-------|--------|--------|-------|-------|
/// after : |---------------||--------|----------------
...
impl Header {
    ...
    fn provide(&mut self, size: usize, align: usize) -> Option<*mut u8> {
        ...
        if self.is_allocated() || !self.can_provide(size, align) {
            ...
            // Each char represetnts 32-byte chunks
            // 
            // |-----|----------------------self--------|------------
            // |-----|----------------------            |------------
            //                                          ^ self.end_addr()
