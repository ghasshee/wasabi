...
struct InterruptInfo {
    ...
    // alignment checks done by FXSAVE / FXSTOR
...
// SDM Vol.3: 6.14.2 64-Bit Mode Stak Frame
...
extern "sysv64" fn inthandler(info: &InterruptInfo, index: usize) {
    ...
    match index {
        ...
        14  => {
            ...
            error!(
                "Caused by: A {} mode {} on a {} page, page structrues are {}",
...
pub const BIT_DPL0     :    u64 = 0b01u64 << 45;
pub const BIT_DPL3     :    u64 = 0b11u64 << 45;
...
/// So, it is programmer's responsibility to ensure that at most one instance of the reference
